...
<div class="wrapper">
    ...
    <div class= "container">
                <div class="main-container">
                   <div class="header-menu">
                       <center><h1>Data Barang</h1></center><br><br>
                       <div class="pull-right"><a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal_add_new"> Tambah Barang</a></div><br><br>
                </div>
...
<tbody>
  ...
  <div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'Dashboard/tambah_barang'?>">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode Barang</label>
                        <div class="col-xs-8">
                            <input name="kodebarang" class="form-control" type="text" placeholder="Kode Barang..." required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="namabarang" class="form-control" type="text" placeholder="Nama Barang..." required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                        <input name="hargabeli" class="form-control" type="text" placeholder="Harga Beli..." required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="hargajual" class="form-control" type="text" placeholder="Harga Jual..." required>
                        </div>
                    </div>
                    <div class="form-group">
